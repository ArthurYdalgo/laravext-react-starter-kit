...
return [
    ...
    /**
     * By default, the Router nexus macro will call $this->match(['GET', 'HEAD'], $uri, $action) to register all the routes generated by a 
     * Route::nexus(...) or Route::laravext(...), but if you want to use a different method, you can set it here.
     * 
     * @see https://laravext.dev/docs/configuration#route-registration-method-route_registration_method
     */
    'route_registration_method' => null,
